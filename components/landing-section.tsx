...
const LandingSection = () => {
  return ( 
    <section className="w-full mb-20 whitespace-pre-wrap py-60 flex flex-col relative gap-20 items-center justify-center text-center bg-[url('/landing-bg.jpg')] bg-center bg-cover  border-b border-t border-slate-950">
